...
dist_filenames = list(
    map(
        lambda x: os.path.dirname(__file__) + "/" + x,
        [
...
if __name__ == "__main__":
    print(
        str(
            get_divergences(
                "syöpä melanooma lääkitys löydös diskurssi substantiivi naiseus tyttöys kokemus subjekti suomi valtio vakavaraisuus tieto aavistus hokema politiikka".split()
            )
        )
    )
