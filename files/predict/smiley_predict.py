...
parser.add_argument(
    "-epochs", type=int, default=10, help="number of epochs for train [default: 10]"
)
parser.add_argument(
...
parser.add_argument(
    ...
    type=int,
    default=10000,
    help="iteration numbers to stop without performance increasing [default: 10000]",
)
parser.add_argument(
    "-save-best",
    type=bool,
...
parser.add_argument(
    "-kernel-num", type=int, default=100, help="number of each kind of kernel"
)
parser.add_argument(
    "-kernel-sizes",
    type=str,
...
cnn.load_state_dict(
    torch.load(os.path.join(os.path.dirname(__file__), "s24_smiley/best_steps_2100.pt"))
)
